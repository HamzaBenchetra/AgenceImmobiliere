    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://192.168.43.185:8080/AgenceImmobiliere/Operateur.jsp">Espace Operateur</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="http://192.168.43.185:8080/AgenceImmobiliere/Operateur.jsp"> <i class="menu-icon fa fa-dashboard"></i>Accueil </a>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children  dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="http://192.168.43.185:8080/AgenceImmobiliere/FixerRDVOp.jsp">Fixer</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="http://192.168.43.185:8080/AgenceImmobiliere/LogoutServlet"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="http://192.168.43.185:8080/AgenceImmobiliere/Operateur.jsp">Accueil</a></li>
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="http://192.168.43.185:8080/AgenceImmobiliere/RechercherAppartOperateur" method="post" class="form-horizontal">
