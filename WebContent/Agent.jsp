    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://192.168.43.185:8080/AgenceImmobiliere/Agent.jsp"> Espace Agent<!-- <img src="images/logo.png" alt="Logo"> --></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="http://192.168.43.185:8080/AgenceImmobiliere/Agent.jsp"> <i class="menu-icon fa fa-dashboard"></i>Accueil </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="http://192.168.43.185:8080/AgenceImmobiliere/ListeRDVAgent">Mes rendez-vous</a></li>
